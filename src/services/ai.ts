...
ПРАВИЛА:
1. category: ID подходящей категории из списка (или 'other'). ВНИМАНИЕ: Строго отличай долгосрочную/постоянную работу (стройка, монолит на несколько месяцев) от разовой подработки на 1 день!
